...
import {ApiError, User, AuthService, OpenAPI} from "../api";
...
export default function AuthProvider(props: { children: React.ReactNode }) {
    ...
    return <AuthContext.Provider value={{isAuthenticated, setToken, userLoading, user, token, init}}>{props.children}</AuthContext.Provider>
}
